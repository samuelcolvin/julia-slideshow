...
function quandl(code, market = :NASDAQ)
  url = "http://www.quandl.com/api/v1/datasets/GOOG/$(market)_$code.csv?sort_order=asc&trim_start=2012-06-01&trim_end=2014-06-01&auth_token=6YzXnhcc8KU6zC9Y8oqh"
  response = get(url)
  sleep(0.5)
